...
//var defender = [MOVE,TOUGH,TOUGH,TOUGH,TOUGH,TOUGH,TOUGH,TOUGH,TOUGH,TOUGH,TOUGH,TOUGH,TOUGH,TOUGH,TOUGH,TOUGH,TOUGH,TOUGH,TOUGH,TOUGH,TOUGH];
var harvester_limit = 2;
var mover_harvester_ratio = 1.5;
var constructor_limit = 1;
var defender_limit = 1;
...
var movers = [];
var towers = [];
var tower_locations = [{x:0,y:-5},{x:-5,y:0}]
var constructionCount = 0;

export function loop() {
    
    if(getTicks() === 1) {
        var creep1 = utils.getObjectsByPrototype(Creep).find(i => i.my);
...
function constructor_behavior(creep) {
    ...
    console.log("constructor.request_energy: " + creep.request_energy);
}
